...
const CommentSection = ({ comments, videoId, currentUser, onCommentsChanged }) => {
    ...
    return (
        <div className="mt-8">
            ...
            <div className="flex items-start space-x-4 mb-6">
                <img
                    src={currentUser?.avatar || 'https://example.com/default-avatar.png'}
                    alt="User"
            ...
            {comments.map((comment) => (
                <div key={comment._id} className="flex items-start space-x-4 mb-6">
                    ...
                    <div className="bg-gray-100 p-3 rounded-lg w-full">
                        ...
                        {/* Edit/Delete buttons */}
                        {comment.user._id === currentUser.userId && editingId !== comment._id && (
                            <div className="flex justify-end gap-3 mt-2 text-sm text-blue-600">
                                ...
                                <button onClick={() => handleDeleteComment(comment._id)} className='cursor-pointer px-4 py-1.5 rounded-full text-sm bg-gray-200 hover:bg-gray-300 text-black'>Delete</button>
                            </div>
                        )}
                    </div>
                </div >
