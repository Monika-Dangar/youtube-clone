...
const Header = ({ onSearch, toggleSidebar }) => {
    ...
    return (
        <>
            <header className="fixed top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-white shadow-sm h-14">
                {/* Left Section */}
                ...
                <div className="flex items-center space-x-3">
                    ...
                    {authUser ? (
                        <>
                            {channelId ? (
                                <Link to={`/channel/${channelId}`}>
                                    <span
                                        className='px-4 py-1.5 rounded-full text-sm whitespace-nowrap cursor-pointer bg-gray-200 hover:bg-gray-300 text-black'
                                    >
                            ...
                            <div className=' rounded-b-full'>
                                <img src={`${authUser?.avatar}`} alt="avatar" className='w-8 h-8' />
                            </div>
                        </>
                    )
                        :
                        <button
                            ...
                            className="flex items-center space-x-2 px-3 py-1.5 border text-blue-600 border-blue-600 rounded-full hover:bg-blue-50"
                        >
            ...
            <ChannelModal
                ...
                onChannelCreated={(channel) => {
                    ...
                    // Maybe refresh the user data here
                }}
            />
