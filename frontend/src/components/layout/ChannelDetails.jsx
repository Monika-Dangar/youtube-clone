        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="max-w-6xl mx-auto px-4">
                <div className="flex flex-col md:flex-row items-start md:items-center py-4 border-b">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="text-gray-500 text-sm mt-1">
                            <span>@{channel.handle || channel.channelName.toLowerCase().replace(/\s+/g, '')}</span>
                ...
                <div className="flex overflow-x-auto scrollbar-hide mt-2">
                    <button
                        className='px-6 py-3 whitespace-nowrap font-medium text-black border-b-2 border-black'
                    >
                        Videos
                    </button>
                </div>
