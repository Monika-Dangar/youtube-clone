                ...
                <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">{video.subscriberCount.toLocaleString()} subscribers</p>
                        </div>
                    ...
                    <div className="flex items-center space-x-3">
                        <button className="bg-gray-100 px-3 py-1 rounded hover:bg-gray-200 text-sm flex items-center space-x-1">
                            <span><AiOutlineLike /></span> <span>{video.likes.toLocaleString()}</span>
                        </button>
                        <button className="bg-gray-100 px-3 py-1 rounded hover:bg-gray-200 text-sm flex items-center space-x-1">
                            <span><AiOutlineDislike /></span> <span>{video.dislikes.toLocaleString()}</span>
                        </button>
                        <button className="bg-gray-100 px-3 py-1 rounded hover:bg-gray-200 text-sm flex items-center space-x-1">
                            <span><PiShareFatLight /></span> <span>Share</span>
                        </button>
                        <button className="bg-gray-100 px-3 py-1 rounded hover:bg-gray-200 text-sm flex items-center space-x-1">
                            <span><GoDownload /></span> <span>Download</span>
                        </button>
                        <button className="bg-gray-100 px-3 py-1 rounded hover:bg-gray-200 text-sm">...</button>
                    </div>
                </div>

                {/* Video Description */}
                <p className="text-sm text-gray-800 mb-6 whitespace-pre-line">{video.description}</p>

                {/* Comments */}
                {/* <CommentSection comments={video.comments} /> */}
                <CommentSection comments={video.comments} videoId={video._id} currentUser={authUser} onCommentsChanged={fetchVideo}
                />
            </div>
